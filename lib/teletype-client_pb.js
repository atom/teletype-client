...
goog.exportSymbol('proto.PortalUpdate.EditorProxyInsertion', null, global);
...
proto.PortalSubscriptionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    workspaceEditorProxiesMetadataList: jspb.Message.toObjectList(msg.getWorkspaceEditorProxiesMetadataList(),
...
proto.PortalSubscriptionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      msg.addWorkspaceEditorProxiesMetadata(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.PortalSubscriptionResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getWorkspaceEditorProxiesMetadataList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      8,
      f,
...
/**
 * repeated EditorProxyMetadata workspace_editor_proxies_metadata = 8;
 * @return {!Array.<!proto.EditorProxyMetadata>}
 */
proto.PortalSubscriptionResponse.prototype.getWorkspaceEditorProxiesMetadataList = function() {
...
proto.PortalSubscriptionResponse.prototype.setWorkspaceEditorProxiesMetadataList = function(value) {
 ...
 */
proto.PortalSubscriptionResponse.prototype.addWorkspaceEditorProxiesMetadata = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 8, opt_value, proto.EditorProxyMetadata, opt_index);
};


proto.PortalSubscriptionResponse.prototype.clearWorkspaceEditorProxiesMetadataList = function() {
  this.setWorkspaceEditorProxiesMetadataList([]);
};
 ...
 * @const
 */
proto.PortalUpdate.oneofGroups_ = [[1,2,3,4,5]];
...
proto.PortalUpdate.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    editorProxyInsertion: (f = msg.getEditorProxyInsertion()) && proto.PortalUpdate.EditorProxyInsertion.toObject(includeInstance, f)
  };
...
proto.PortalUpdate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.PortalUpdate.EditorProxyInsertion;
      reader.readMessage(value,proto.PortalUpdate.EditorProxyInsertion.deserializeBinaryFromReader);
      msg.setEditorProxyInsertion(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.PortalUpdate.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getEditorProxyInsertion();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.PortalUpdate.EditorProxyInsertion.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.PortalUpdate.EditorProxyInsertion = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PortalUpdate.EditorProxyInsertion, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.PortalUpdate.EditorProxyInsertion.displayName = 'proto.PortalUpdate.EditorProxyInsertion';
}
 ...
 * @return {!Object}
 */
proto.PortalUpdate.EditorProxyInsertion.prototype.toObject = function(opt_includeInstance) {
  return proto.PortalUpdate.EditorProxyInsertion.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PortalUpdate.EditorProxyInsertion} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PortalUpdate.EditorProxyInsertion.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PortalUpdate.EditorProxyInsertion}
 */
proto.PortalUpdate.EditorProxyInsertion.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PortalUpdate.EditorProxyInsertion;
  return proto.PortalUpdate.EditorProxyInsertion.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PortalUpdate.EditorProxyInsertion} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PortalUpdate.EditorProxyInsertion}
 */
proto.PortalUpdate.EditorProxyInsertion.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PortalUpdate.EditorProxyInsertion.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PortalUpdate.EditorProxyInsertion.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PortalUpdate.EditorProxyInsertion} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PortalUpdate.EditorProxyInsertion.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {?proto.EditorProxyMetadata}
 */
proto.PortalUpdate.EditorProxyInsertion.prototype.getEditorProxyMetadata = function() {
...
proto.PortalUpdate.EditorProxyInsertion.prototype.setEditorProxyMetadata = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.PortalUpdate.EditorProxyInsertion.prototype.clearEditorProxyMetadata = function() {
 ...
 * @return {!boolean}
 */
proto.PortalUpdate.EditorProxyInsertion.prototype.hasEditorProxyMetadata = function() {
...
/**
 * optional EditorProxyInsertion editor_proxy_insertion = 5;
 * @return {?proto.PortalUpdate.EditorProxyInsertion}
 */
proto.PortalUpdate.prototype.getEditorProxyInsertion = function() {
  return /** @type{?proto.PortalUpdate.EditorProxyInsertion} */ (
    jspb.Message.getWrapperField(this, proto.PortalUpdate.EditorProxyInsertion, 5));
};


/** @param {?proto.PortalUpdate.EditorProxyInsertion|undefined} value */
proto.PortalUpdate.prototype.setEditorProxyInsertion = function(value) {
  jspb.Message.setOneofWrapperField(this, 5, proto.PortalUpdate.oneofGroups_[0], value);
};


proto.PortalUpdate.prototype.clearEditorProxyInsertion = function() {
  this.setEditorProxyInsertion(undefined);
};
 ...
 * @return {!boolean}
 */
proto.PortalUpdate.prototype.hasEditorProxyInsertion = function() {
