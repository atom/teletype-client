...
class PeerConnection {
  constructor ({localPeerId, peerId, initiator, fragmentSize, pool, restGateway, iceServers}) {
    ...
    this.receivedOfferOrAnswer = false
  ...
  handleIceConnectionStateChange () {
    ...
    const connected = (iceConnectionState === 'connected' || iceConnectionState === 'completed' && this.channel)
  ...
  async receiveSignal (signal) {
    if (signal.offer) {
      this.receivedOfferOrAnswer = true
