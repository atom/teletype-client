...
class PeerConnection {
  ...
  sendSignal (signal) {
    ...
    signal.sequenceNumber = this.outgoingSignalSequenceNumber++
    const body = {
  ...
  async receiveSignal (signal) {
    ...
    while (true) {
      const signal = this.receivedSignals[this.incomingSignalSequenceNumber]
      if (signal) {
        delete this.receivedSignals[this.incomingSignalSequenceNumber]
        this.incomingSignalSequenceNumber++
