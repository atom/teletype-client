...
class PeerConnection {
  constructor ({localPeerId, remotePeerId, fragmentSize, pool, iceServers, signalingProvider}) {
  ...
  disconnect () {
    ...
    this.pool.didDisconnect(this.remotePeerId)
  ...
  finishReceiving (envelope) {
    ...
    this.pool.didReceiveMessage({senderId: this.remotePeerId, message})
  }
  ...
  handleTrack ({track}) {
    ...
    this.pool.didReceiveTrack({senderId: this.remotePeerId, track})
  }
}
