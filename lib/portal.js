...
module.exports =
class Portal {
  constructor ({id, hostPeerId, siteId, peerPool, connectionTimeout, tetherBreakPeriod}) {
    this.id = id
    this.hostPeerId = hostPeerId
    this.siteId = siteId
    this.tetherBreakPeriod = tetherBreakPeriod
  ...
  async join () {
    ...
    if (activeEditorProxyMessage) {
      ...
      this.activeEditorProxy.tetherToSiteId(1)
    }
  ...
  async receiveEditorProxySwitch (editorProxySwitch) {
    ...
    this.activeEditorProxy = editorProxy
    this.delegate.setActiveEditorProxy(this.activeEditorProxy)
    if (this.activeEditorProxy) this.activeEditorProxy.tetherToSiteId(1)
  }
