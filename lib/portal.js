...
class Portal {
  ...
  async join () {
    ...
    if (activeEditorProxyMessage) {
      ...
      this.activeEditorProxySubscriptions = new CompositeDisposable()
      this.activeEditorProxySubscriptions.add(this.activeEditorProxy.onDidScroll(this.activeEditorDidScroll.bind(this)))
      this.activeEditorProxySubscriptions.add(this.activeEditorProxy.onDidUpdateLocalSelections(this.activeEditorDidUpdateLocalSelections.bind(this)))
      this.activeEditorProxySubscriptions.add(this.activeEditorProxy.onDidUpdateRemoteSelections(this.activeEditorDidUpdateRemoteSelections.bind(this)))
      this.activeEditorProxySubscriptions.add(this.activeEditorProxy.bufferProxy.onDidUpdateText(this.activeEditorDidUpdateText.bind(this)))
      this.delegate.addEditorProxy(this.activeEditorProxy)
  ...
  async receiveEditorProxySwitch (senderSiteId, editorProxySwitch) {
    ...
    const isRetracted = this.resolveFollowState() === FollowState.RETRACTED
    const leaderDidSwitch = senderSiteId === this.resolveLeaderSiteId()
    if (leaderDidSwitch && isRetracted && editorProxy != this.activeEditorProxy) {
      this.didChangeActiveEditorProxy(editorProxy)
