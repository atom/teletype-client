...
class HostPortal {
  ...
  async subscribe () {
    this.subscriptions.push(await this.subscribeToSiteConnectionLostEvents())
  }

  subscribeToSiteConnectionLostEvents () {
    return this.pubSubGateway.subscribe(
      `/portals/${this.id}`,
      'site-did-lose-connection',
      this.receiveSiteConnectionLost.bind(this)
    )
  }

  receiveSiteConnectionLost (message) {
...
class GuestPortal {
  ...
  async subscribe () {
    this.subscriptions.push(
      ...
      await this.subscribeToSiteConnectionLostEvents(),
