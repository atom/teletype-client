...
class Portal {
  constructor ({id, hostPeerId, siteId, peerPool, connectionTimeout, tetherDisconnectWindow}) {
    ...
    this.workspaceEditorProxiesMetadataById = new Map()
  ...
  async setDelegate (delegate) {
    ...
    if (!this.isHost) {
      this.workspaceEditorProxiesMetadataById.forEach((editorProxyMetadata) => {
        this.delegate.addEditorProxy(editorProxyMetadata)
      })
    }
  ...
  async join () {
    ...
    response.getWorkspaceEditorProxiesMetadataList().forEach((editorProxyMetadataMessage) => {
      const editorProxyMetadata = EditorProxyMetadata.deserialize(editorProxyMetadataMessage)
      this.workspaceEditorProxiesMetadataById.set(editorProxyMetadata.id, editorProxyMetadata)
      this.delegate.addEditorProxy(editorProxyMetadata)
    })
  ...
  activateEditorProxy (newEditorProxy) {
    if (newEditorProxy && !this.workspaceEditorProxiesMetadataById.has(newEditorProxy.id)) {
      this.addEditorProxy(newEditorProxy)
    }
  ...
  addEditorProxy (editorProxy) {
    assert(this.isHost, 'Only the host can add editor proxies')

    const editorProxyMetadata = editorProxy.getMetadata()
    this.workspaceEditorProxiesMetadataById.set(editorProxy.id, editorProxyMetadata)

    const editorProxyInsertionMessage = new Messages.PortalUpdate.EditorProxyInsertion()
    editorProxyInsertionMessage.setEditorProxyMetadata(editorProxyMetadata.serialize())
    const updateMessage = new Messages.PortalUpdate()
    updateMessage.setEditorProxyInsertion(editorProxyInsertionMessage)
  ...
  removeEditorProxy (editorProxy) {
    ...
    this.workspaceEditorProxiesMetadataById.delete(editorProxy.id)
  ...
  sendSubscriptionResponse (requestId) {
    ...
    const workspaceEditorProxiesMetadata = []
    this.workspaceEditorProxiesMetadataById.forEach((editorProxyMetadata) => {
      workspaceEditorProxiesMetadata.push(editorProxyMetadata.serialize())
    })
    response.setWorkspaceEditorProxiesMetadataList(workspaceEditorProxiesMetadata)
  ...
  async receiveUpdate ({senderId, body}) {
    ...
    if (updateMessage.hasEditorProxyInsertion()) {
      this.receiveEditorProxyInsertion(updateMessage.getEditorProxyInsertion())
  ...
  receiveEditorProxyInsertion (editorProxyInsertion) {
    const editorProxyMetadata = EditorProxyMetadata.deserialize(editorProxyInsertion.getEditorProxyMetadata())
    this.workspaceEditorProxiesMetadataById.set(editorProxyMetadata.id, editorProxyMetadata)
    this.delegate.addEditorProxy(editorProxyMetadata)
  }
  ...
  receiveEditorProxyRemoval (editorProxyRemoval) {
    ...
    const editorProxyMetadata = this.workspaceEditorProxiesMetadataById.get(editorProxyId)
    if (editorProxyMetadata) {
      this.workspaceEditorProxiesMetadataById.delete(editorProxyId)
      this.delegate.removeEditorProxy(editorProxyMetadata)
    }
  }
