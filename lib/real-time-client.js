...
class RealTimeClient {
  constructor ({oauthToken, restGateway, pubSubGateway, connectionTimeout, testEpoch, pusherKey, baseURL, didCreateOrJoinPortal}) {
  ...
  async _initialize (options) {
    ...
    this.peerPool = new PeerPool({
      peerId: this.peerId,
      oauthToken: options ? options.oauthToken : null,
