...
class TextEditor {
  ...
  constructor ({id, textBuffer, selectionLayerIdsBySiteId, selections, router, siteId}) {
    ...
    this.subscriptions.add(
      this.textBuffer.onDidUpdateMarkers(this.textBufferDidUpdateMarkers.bind(this))
    )
    this.subscriptions.add(
  ...
  setDelegate (delegate) {
    ...
    if (this.delegate) {
      const layersBySiteId = this.textBuffer.getMarkers()
  ...
  textBufferDidUpdateMarkers (markerUpdates) {
    if (this.delegate) {
