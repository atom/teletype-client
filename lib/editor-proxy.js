...
class EditorProxy {
  static async deserialize (message, props) {
    ...
    const bufferProxy = props.bufferProxiesById.get(id)
  ...
  constructor ({id, bufferProxy, selectionLayerIdsBySiteId, selections, router, siteId}) {
    this.id = id
    this.siteId = siteId
  ...
  updateSelections (selections) {
    ...
    if (localSelectionsLayerId == null) {
      ...
      this.router.notify(`/editors/${this.id}`, editorProxyUpdateMessage.serializeBinary())
    }
