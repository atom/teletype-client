...
class EditorProxy {
  ...
  setTetherState (newState) {
    ...
    tetherUpdateMessage.setLeaderSiteId(this.tetherSiteId)
    tetherUpdateMessage.setState(this.tetherState)
    const editorProxyUpdateMessage = new Messages.EditorProxyUpdate()
  ...
  getTetherPosition () {
    ...
    if (tetherSiteId && leaderSelectionsLayerId) {
  ...
  receiveTetherUpdate (tetherUpdate) {
    const oldLocalTetherSiteId = this.getTetherSiteId()
    ...
    const newLocalTetherSiteId = this.getTetherSiteId()
