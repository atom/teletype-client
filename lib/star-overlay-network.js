...
class StarOverlayNetwork {
  ...
  receive ({senderId, message}) {
    ...
    if (networkMessage.hasStarConnection()) {
      ...
      this.receiveStarJoinNotification(networkMessage.getStarJoinNotification())
  ...
  receiveConnection (rawMessage, connectionMessage) {
    ...
    starJoinNotification.setMember(networkMember)
  ...
  receiveStarJoinNotification (starJoinNotification) {
    const member = starJoinNotification.getMember()
