...
class StarOverlayNetwork {
  constructor ({id, peerPool, isHub}) {
    ...
    this.usersByPeerId.set(this.getPeerId(), this.peerPool.getUser(this.getPeerId())) // TODO Consider moving this to a fn, since same this logic exists in multiple places in this class
  ...
  disconnect () {
    ...
    this.usersByPeerId.clear()
    this.usersByPeerId.set(this.getPeerId(), this.peerPool.getUser(this.getPeerId()))
