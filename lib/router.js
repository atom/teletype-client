...
class Router {
  ...
  request (recipientId, channelId, message) {
    if (message) message = convertToProtobufCompatibleBuffer(message)
  ...
  broadcastTrack (channelId, metadata, track, stream) {
    ...
    routerTrackMetadata.setApplicationMetadata(convertToProtobufCompatibleBuffer(metadata))
  ...
  receiveResponse (response) {
    ...
    requestResolveCallback(convertToProtobufCompatibleBuffer(response.getBody()))
  }
  ...
  handleTrack ({senderId, metadata, track}) {
    ...
    const applicationMetadata = convertToProtobufCompatibleBuffer(routerTrackMetadata.getApplicationMetadata())
