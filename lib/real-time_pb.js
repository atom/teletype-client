...
proto.EditorProxyUpdate.TetherUpdate.toObject = function(includeInstance, msg) {
  var f, obj = {
    senderSiteId: jspb.Message.getFieldWithDefault(msg, 1, 0),
    tetherSiteId: jspb.Message.getFieldWithDefault(msg, 2, 0),
    tetherState: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
...
proto.EditorProxyUpdate.TetherUpdate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setSenderSiteId(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setTetherSiteId(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setTetherState(value);
      break;
    default:
      reader.skipField();
      break;
...
/**
 * optional uint32 sender_site_id = 1;
 * @return {number}
 */
proto.EditorProxyUpdate.TetherUpdate.prototype.getSenderSiteId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.EditorProxyUpdate.TetherUpdate.prototype.setSenderSiteId = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional uint32 tether_site_id = 2;
 * @return {number}
 */
proto.EditorProxyUpdate.TetherUpdate.prototype.getTetherSiteId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.EditorProxyUpdate.TetherUpdate.prototype.setTetherSiteId = function(value) {
  jspb.Message.setField(this, 2, value);
};


/**
 * optional uint32 tether_state = 3;
 * @return {number}
 */
proto.EditorProxyUpdate.TetherUpdate.prototype.getTetherState = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.EditorProxyUpdate.TetherUpdate.prototype.setTetherState = function(value) {
