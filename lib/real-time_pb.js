...
goog.exportSymbol('proto.NetworkMessage.StarMediaTrackBroadcast', null, global);
...
proto.NetworkMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    starMediaTrackBroadcast: (f = msg.getStarMediaTrackBroadcast()) && proto.NetworkMessage.StarMediaTrackBroadcast.toObject(includeInstance, f)
  };
...
proto.NetworkMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.NetworkMessage.StarMediaTrackBroadcast;
      reader.readMessage(value,proto.NetworkMessage.StarMediaTrackBroadcast.deserializeBinaryFromReader);
      msg.setStarMediaTrackBroadcast(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.NetworkMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getStarMediaTrackBroadcast();
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.NetworkMessage.StarMediaTrackBroadcast.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.NetworkMessage.StarMediaTrackBroadcast = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.NetworkMessage.StarMediaTrackBroadcast, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.NetworkMessage.StarMediaTrackBroadcast.displayName = 'proto.NetworkMessage.StarMediaTrackBroadcast';
}
 ...
 * @return {!Object}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.toObject = function(opt_includeInstance) {
  return proto.NetworkMessage.StarMediaTrackBroadcast.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.NetworkMessage.StarMediaTrackBroadcast} msg The msg instance to transform.
 * @return {!Object}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.toObject = function(includeInstance, msg) {
  var f, obj = {
    senderId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.NetworkMessage.StarMediaTrackBroadcast}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.NetworkMessage.StarMediaTrackBroadcast;
  return proto.NetworkMessage.StarMediaTrackBroadcast.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.NetworkMessage.StarMediaTrackBroadcast} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.NetworkMessage.StarMediaTrackBroadcast}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.NetworkMessage.StarMediaTrackBroadcast.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.NetworkMessage.StarMediaTrackBroadcast} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.NetworkMessage.StarMediaTrackBroadcast.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSenderId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.getSenderId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.setSenderId = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.getTrackId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.setTrackId = function(value) {
  jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.getMetadata = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {string}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.getMetadata_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getMetadata()));
};
 ...
 * @return {!Uint8Array}
 */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.getMetadata_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getMetadata()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.NetworkMessage.StarMediaTrackBroadcast.prototype.setMetadata = function(value) {
  jspb.Message.setField(this, 3, value);
};
...
/**
 * optional StarMediaTrackBroadcast star_media_track_broadcast = 7;
 * @return {?proto.NetworkMessage.StarMediaTrackBroadcast}
 */
proto.NetworkMessage.prototype.getStarMediaTrackBroadcast = function() {
  return /** @type{?proto.NetworkMessage.StarMediaTrackBroadcast} */ (
    jspb.Message.getWrapperField(this, proto.NetworkMessage.StarMediaTrackBroadcast, 7));
};


/** @param {?proto.NetworkMessage.StarMediaTrackBroadcast|undefined} value */
proto.NetworkMessage.prototype.setStarMediaTrackBroadcast = function(value) {
  jspb.Message.setOneofWrapperField(this, 7, proto.NetworkMessage.oneofGroups_[0], value);
};


proto.NetworkMessage.prototype.clearStarMediaTrackBroadcast = function() {
  this.setStarMediaTrackBroadcast(undefined);
};
 ...
 * @return {!boolean}
 */
proto.NetworkMessage.prototype.hasStarMediaTrackBroadcast = function() {
