...
goog.exportSymbol('proto.NetworkMessage.StarConnectionEcho', null, global);
...
proto.PortalUpdate.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    activeTextBufferId: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.PortalUpdate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setActiveTextBufferId(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.PortalUpdate.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getActiveTextBufferId();
  if (f !== 0) {
    writer.writeUint32(
      2,
      f
 ...
 * @return {number}
 */
proto.PortalUpdate.prototype.getActiveTextEditorId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.PortalUpdate.prototype.setActiveTextEditorId = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional uint32 active_text_buffer_id = 2;
 * @return {number}
 */
proto.PortalUpdate.prototype.getActiveTextBufferId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.PortalUpdate.prototype.setActiveTextBufferId = function(value) {
...
proto.NetworkMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    starConnectionEcho: (f = msg.getStarConnectionEcho()) && proto.NetworkMessage.StarConnectionEcho.toObject(includeInstance, f),
...
proto.NetworkMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.NetworkMessage.StarConnectionEcho;
      reader.readMessage(value,proto.NetworkMessage.StarConnectionEcho.deserializeBinaryFromReader);
      msg.setStarConnectionEcho(value);
      break;
    case 6:
...
proto.NetworkMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getStarConnectionEcho();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.NetworkMessage.StarConnectionEcho.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.NetworkMessage.StarConnectionEcho = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.NetworkMessage.StarConnectionEcho, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.NetworkMessage.StarConnectionEcho.displayName = 'proto.NetworkMessage.StarConnectionEcho';
}
 ...
 * @return {!Object}
 */
proto.NetworkMessage.StarConnectionEcho.prototype.toObject = function(opt_includeInstance) {
  return proto.NetworkMessage.StarConnectionEcho.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.NetworkMessage.StarConnectionEcho} msg The msg instance to transform.
 * @return {!Object}
 */
proto.NetworkMessage.StarConnectionEcho.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.NetworkMessage.StarConnectionEcho}
 */
proto.NetworkMessage.StarConnectionEcho.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.NetworkMessage.StarConnectionEcho;
  return proto.NetworkMessage.StarConnectionEcho.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.NetworkMessage.StarConnectionEcho} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.NetworkMessage.StarConnectionEcho}
 */
proto.NetworkMessage.StarConnectionEcho.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.NetworkMessage.StarConnectionEcho.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.NetworkMessage.StarConnectionEcho.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.NetworkMessage.StarConnectionEcho} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.NetworkMessage.StarConnectionEcho.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.NetworkMessage.StarConnectionEcho.prototype.getStatus = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.NetworkMessage.StarConnectionEcho.prototype.setStatus = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.NetworkMessage.StarConnectionEcho.prototype.getPeerId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.NetworkMessage.StarConnectionEcho.prototype.setPeerId = function(value) {
  jspb.Message.setField(this, 2, value);
};
...
/**
 * optional StarConnectionEcho star_connection_echo = 5;
 * @return {?proto.NetworkMessage.StarConnectionEcho}
 */
proto.NetworkMessage.prototype.getStarConnectionEcho = function() {
  return /** @type{?proto.NetworkMessage.StarConnectionEcho} */ (
    jspb.Message.getWrapperField(this, proto.NetworkMessage.StarConnectionEcho, 5));
};


/** @param {?proto.NetworkMessage.StarConnectionEcho|undefined} value */
proto.NetworkMessage.prototype.setStarConnectionEcho = function(value) {
  jspb.Message.setOneofWrapperField(this, 5, proto.NetworkMessage.oneofGroups_[0], value);
};


proto.NetworkMessage.prototype.clearStarConnectionEcho = function() {
  this.setStarConnectionEcho(undefined);
};
 ...
 * @return {!boolean}
 */
proto.NetworkMessage.prototype.hasStarConnectionEcho = function() {
